"""
Pure-numpy / onnxruntime YOLO inference.

Supports multi-class detection with class-aware NMS (matches Ultralytics behavior
for the 4-class equipment detector).
"""
...
def _nms_class_aware(
    ...
    """Class-aware NMS: run NMS per class, merge, sort by score, truncate."""
    if boxes_xyxy.size == 0:
        return []
...
class YoloOnnxDetector:
    """YOLO detector running through onnxruntime."""
